...
const lista_produtos = { 
  produtos: [ 
    ...
    { id: 6, descricao: "Feijão Carioca 1000gr", valor: 12.00, marca: "Só Feijão"  }, 
  ] 
} 
...
app.post (ENDPOINT + 'produto', (req, res, next) => 
{
  ...
  {
    res.status(400).json ({message: 'Os seguintes parametros são obrigatórios: id, descricao, valor, marca.'})
  }
})
//incluir
